...
urlpatterns = [
    ...
    url(r'^measurements/$', views.MeasurementView.as_view(),
        name='measurements'),
    url(r'^measurement/create$', views.MeasurementCreate.as_view(),
        name="create_measurement"),
    url(r'^measurement/(?P<pk>[0-9]+)/edit$', views.MeasurementEdit.as_view(),
        name='edit_measurement'),
    url(r'^measurement/(?P<pk>[0-9]+)/delete$',
